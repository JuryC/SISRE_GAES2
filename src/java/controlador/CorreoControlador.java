...
public class CorreoControlador implements Serializable {
    ...
    public void enviarEmail(String destinatario, String asunto, String descripcion) throws NoSuchProviderException, MessagingException {
        try {
            ...
            String correoEnvia = "sistemadesoluciones@gmail.com";
            String contrasena = "3257115499";
...
"                <div>\n" +
"                    <a href='#'>\n" +
"                        <img src='http://imgfz.com/i/hQVskYK.png' style='width: 300px;'/>\n" +
"                    </a>\n" +
"                </div>\n" +
"            </div>\n" +
"        </div>\n" +
...
"        </div>";
    ...
    public void notificarTodos() throws NoSuchProviderException, MessagingException{
        ...
        this.enviarEmail(u.getEmail(), asunto, pagina());
        }
    }
